...
class AdminArtistsAllTab extends StatefulWidget {
  @override
  _AdminArtistsAllTabState createState() => _AdminArtistsAllTabState();
}

class _AdminArtistsAllTabState extends State<AdminArtistsAllTab> {
  ...
  void paginacion(BuildContext context) async {
    ...
    await Future.wait([
      eventsProvider.getArtists(limit: _limit, offset: _offset, search: null),
    ]);
