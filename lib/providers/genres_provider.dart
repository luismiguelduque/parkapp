...
class GenresProvider extends ChangeNotifier {
  ...
  Future<void> getArtisticGenres() async {
    final Uri uri =developmentMode ? Uri.https(apiUrl, "api/artistic-genre", {}) : Uri.http(apiUrl, "api/artistic-genre", {});
    try {
  ...
  Future<Map<String, dynamic>> deleteCategoryGenre(int genreId) async {
    Map<String, dynamic> respJson = {};
    final Uri uri =developmentMode ? Uri.https(apiUrl, "api/artistic-genre/$genreId", {}) : Uri.http(apiUrl, "api/artistic-genre/$genreId", {});
    try {
