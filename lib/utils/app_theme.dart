...
class AppTheme {
  ...
  static Color primaryColors = HexColor("#C6E353");
  static Color secondaryColors = HexColor("#411B8E");
  ...
  static TextTheme _buildTextTheme(TextTheme base) {
    ...
    return base.copyWith(
      ...
      headline1: base.headline1.copyWith(fontFamily: fontName, fontSize: 25, fontWeight: FontWeight.bold),
      headline2: base.headline2.copyWith(fontFamily: fontName),
      headline3: base.headline3.copyWith(fontFamily: fontName),
      headline4: base.headline4.copyWith(fontFamily: fontName),
      headline5: base.headline5.copyWith(fontFamily: fontName),
      headline6: base.headline6.copyWith(fontFamily: fontName, fontSize: 15),
