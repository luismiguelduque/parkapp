...
//**** Colors ***//
const redColor = Color.fromRGBO(252, 0, 0, 1);
const greenColor = Color.fromRGBO(57, 187, 12, 1);
const whiteColor = Colors.white;
const blackColor = Color.fromRGBO(11, 11, 11, 1);
const blueDarkColor = Color.fromRGBO(10, 2, 21, 1);
const greyColor = Color.fromRGBO(67, 69, 72, 1);
const greyLightColor = Color.fromRGBO(102, 102, 102, 1);
const greyVeryLightColor = Color.fromRGBO(186, 183, 183, 1);
const blueColor = Color.fromRGBO(0, 96, 167, 1);
const blueLightColor = Color.fromRGBO(111, 194, 235, 1);
const primaryColor = Color.fromRGBO(198, 227, 83, 1);
const secondaryColor = Color.fromRGBO(65, 27, 142, 1);

const status1Color = Color(0xff88eb24);
const status2Color = Color(0xffcc4615);
const status3Color = Color(0xfffc0000);
const status4Color = Color(0xff88eb24);
const status5Color = Color(0xffe2260d);
const status6Color = Color(0xff1793e0);
const status7Color = Color(0xff49ad24);
